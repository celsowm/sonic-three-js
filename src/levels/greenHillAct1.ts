...
export const greenHillTheme: StageThemeDefinition = {
  ...
  skyColor: 0x45acf2,
  environment: {
    fog: { color: 0x8edcf5, near: 250, far: 1150 },
    hemisphere: {
      skyColor: 0xdff4ff,
      groundColor: 0x3d6b24,
      intensity: 1.18,
    },
    sun: {
      color: 0xfff4cf,
...
export const greenHillAct1: LevelDefinition = {
  ...
  decorations: [
    ...
    scatter('green-hill-palm-tree', undefined, [
      { x: 90, y: 0, z: -34, scale: 0.48 },
      { x: 250, y: 0, z: -28, scale: 0.56 },
    ...
    scatter('green-hill-props', 'ghz-flower-red', [
      ...flowerInstances([35, 78, 455, 505, 545, 1050, 1100, 1310, 1360, 1410, 1620, 1830, 1920, 2010], -12, 1.5),
      { x: 300, y: 18, z: -23, scale: 1.75 },
      { x: 1540, y: 18, z: -22, scale: 1.7 },
    ]),
    scatter('green-hill-props', 'ghz-flower-blue', [
      ...flowerInstances([18, 105, 470, 520, 575, 1025, 1075, 1285, 1340, 1390, 1650, 1855, 1950, 2035], -14, 1.4),
